...
-- being shown off, but only the owner curates it (write/update/delete) —
-- portfolio content is a marketing/positioning decision, not day-to-day
-- delivery work.
--
...
-- Anonymous visitors only ever see the individual items marked published —
-- the owner can build/edit a case study privately for as long as they like
