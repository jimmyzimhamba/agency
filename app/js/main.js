  ...
  const box = el(`
    <div>
      <div class="task-row" data-go="copilot" style="cursor:pointer;">
        <div class="icon-badge sm"><svg viewBox="0 0 32 27" fill="currentColor"><path d="M16 14 L28.6 10.6 L22.4 11.2 L27 7.1 L21.3 9.5 L24.5 4.2 L19.8 8.1 L21.3 2.1 L17.9 7.3 L17.6 1.1 Z"/><path d="M16 14 L3.4 10.6 L9.6 11.2 L5 7.1 L10.7 9.5 L7.5 4.2 L12.2 8.1 L10.7 2.1 L14.1 7.3 L14.4 1.1 Z"/><path d="M14.5 15 L16 26 L17.5 15 Z"/><circle cx="16" cy="13" r="1.3"/><path d="M16 11.2 L14.9 13 L17.1 13 Z"/></svg></div>
        <div class="task-label">Phoenix AI</div>
      </div>
