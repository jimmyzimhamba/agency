  ...
  const wrap = el(`
    <div>
      ...
      <div data-panel="settings" style="${panelStyle("settings")}">
        ...
        <p class="text-faint" style="font-size:10px;text-align:center;margin-top:4px;opacity:0.6;">build sxc-v173</p>
      </div>
    </div>
  `);
...
function openEditProfileModal() {
  ...
  const box = el(`
    <div>
      ...
      <button class="btn btn-primary" id="ep-save" style="margin-top:2px;">Save Changes</button>
    </div>
  `);
